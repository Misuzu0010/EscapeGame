...
public class EscapeGame : ModuleRules
{
	public EscapeGame(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PublicIncludePaths.AddRange(new string[] {
			"EscapeGame",
			"EscapeGame/AI",
			"EscapeGame/Character",
			"EscapeGame/Character/Animation",
			"EscapeGame/Character/Components",
			"EscapeGame/Combat",
			"EscapeGame/Core",
			"EscapeGame/Dialogue",
			"EscapeGame/EditorTools",
			"EscapeGame/Interaction",
			"EscapeGame/Interfaces",
			"EscapeGame/Inventory",
			"EscapeGame/Inventory/Items",
			"EscapeGame/Inventory/UI",
			"EscapeGame/UI",
